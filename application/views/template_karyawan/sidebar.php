...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<a href="index3.html" class="brand-link">
		<img src="<?php echo base_url() ?>/assets/img/baliindah.png" class="brand-image img-circle elevation-3" style="opacity: .8">
	...
	<div class="sidebar">
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				<li class="nav-item">
					<a href="<?= base_url('karyawan/dashboard') ?>" class="nav-link">
				...
				<li class="nav-item">
					<a href="<?= base_url('karyawan/DataKegiatan') ?>" class="nav-link">
						<i class="nav-icon fas fa-cube"></i>
						<p>Data Kegiatan</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="<?= base_url('karyawan/DataGaji') ?>" class="nav-link">
						<i class="nav-icon fas fa-money-check-alt"></i>
						<p>Data Gaji</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="<?= base_url('karyawan/UbahPassword') ?>" class="nav-link">
